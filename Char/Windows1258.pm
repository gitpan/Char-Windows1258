...
######################################################################
#
# Char::Windows1258 - Source code filter to Windows-1258 script
#
...
sub Char::Windows1258::escape_script {
    ...
    if (m/^ use Char::Ewindows1258(?:\s+[0-9\.]*)?\s*; $/oxms) {
        ...
        $e_script .= sprintf("use Char::Ewindows1258 %s;\n%s", $Char::Ewindows1258::VERSION, $use_re_eval); # require run-time routines version
...
sub e_qr {
    ...
    for (my $i=0; $i <= $#char; $i++) {
        ...
        # /i modifier
        elsif ($ignorecase and ($char[$i] =~ m/\A [\x00-\xFF] \z/oxms) and (Char::Ewindows1258::uc($char[$i]) ne Char::Ewindows1258::lc($char[$i]))) {
            $char[$i] = '[' . Char::Ewindows1258::uc($char[$i]) . Char::Ewindows1258::lc($char[$i]) . ']';
        }
...
Char::Windows1258 - Source code filter to escape Windows-1258

=head1 SYNOPSIS

  use Char::Windows1258;
  use Char::Windows1258 version;         --- require version
...
http://search.cpan.org/dist/Char-Char::Windows1258/Char::Windows1258/JA.pm
...
better, fitter Char::Windows1258.
...
=head1 Calling 'Char::Ewindows1258::ignorecase()' (Char/Windows1258.pm provides)

Char/Windows1258.pm applies calling 'Char::Ewindows1258::ignorecase()' instead of /i modifier.
...
Definitions in Char/Ewindows1258.pm.
  ...
  @{Char::Ewindows1258::eV}             qr{(?:[^\x0C\x0A\x0D])}
...
=head1 Escaping Built-in Standard Module (Char/Ewindows1258.pm provides)

Char/Ewindows1258.pm does "BEGIN { unshift @INC, '/Perl/site/lib/Char::Windows1258' }" at head.
Store the standard module modified for Char::Windows1258 software in this directory to
override built-in standard modules.

=head1 Escaping Standard Module Content (You do)

You need copy built-in standard module to /Perl/site/lib/Char::Windows1258 and change
'use utf8;' to 'use Char::Windows1258;' in its. You need help yourself for now.
...
Contrasting is Encode module and describing "use Char::Windows1258;" on this software,
