...
#               $pattern .= "(?:$your_char)",   # UNIX style
        ...
        my $matchsub = sub { Ewindows1258::fc($_[0]) =~ m{\A $pattern \z}xms };
...
=item Reverse index string
  ...
  This function works just like Ewindows1258::index except that it returns the byte
...
=item Lower case string
  ...
  You can use the Ewindows1258::fc function for case-insensitive comparisons via Windows1258
  software.
...
=item Fold case string
  ...
  New to Windows1258 software, this function returns the full Unicode-like casefold of
...
=item Filename expansion (globbing)
  ...
  The Ewindows1258::glob function grandfathers the use of whitespace to separate multiple
