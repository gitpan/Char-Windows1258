...
=head1 Un-Escaping \ of \N, \p, \P, and \X (Windows1258 software provides)

Windows1258 software removes '\' at head of alphanumeric regexp metasymbols \N, \p, \P
...
=head1 Escaping Built-in Functions (Windows1258 software provide)
