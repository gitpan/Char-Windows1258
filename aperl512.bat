...
rem ======================================================================
rem 
rem  aperl512 - execute perlscript on ActivePerl 5.12 without %PATH% settings
...
aperl512 - execute perlscript on ActivePerl 5.12 without %PATH% settings (poor App::perlbrew)
...
This software is useful when ActivePerl 5.12 and other version of perl are on the one
