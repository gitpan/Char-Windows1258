...
rem ======================================================================
rem 
rem  perl512 - execute perlscript on ActivePerl 5.8 or Strawbery Perl 5.8 without %PATH% settings
...
perl512 - execute perlscript on ActivePerl 5.8 or Strawbery Perl 5.8 without %PATH% settings (poor App::perlbrew)
