...
rem ======================================================================
rem 
rem  perl516 - execute perlscript on ActivePerl 5.8 or Strawbery Perl 5.8 without %PATH% settings
...
perl516 - execute perlscript on ActivePerl 5.8 or Strawbery Perl 5.8 without %PATH% settings (poor App::perlbrew)
