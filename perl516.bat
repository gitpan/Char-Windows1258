...
rem ======================================================================
rem 
rem  perl516 - execute perlscript on the perl5.16 without %PATH% settings
...
perl516 - execute perlscript on the perl5.16 without %PATH% settings (poor App::perlbrew)
