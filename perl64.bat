...
rem ======================================================================
rem 
rem  perl64 - execute perlscript on ActivePerl 64 or Strawbery Perl 64 without %PATH% settings
...
perl64 - execute perlscript on ActivePerl 64 or Strawbery Perl 64 without %PATH% settings (poor App::perlbrew)
...
This software is useful when perl 64 and other version of perl are on the one
computer. Do not set perl 64's bin directory to %PATH%.

It is necessary to install perl 64 in "\Perl64\bin" directory of the drive of
either. This software is executed by perl 64, and find the perl 64 and execute it.

 Find perl 64 order by,
