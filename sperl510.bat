...
rem ======================================================================
rem 
rem  sperl510 - execute perlscript on Strawbery Perl 5.8 without %PATH% settings
...
sperl510 - execute perlscript on Strawbery Perl 5.8 without %PATH% settings (poor App::perlbrew)
