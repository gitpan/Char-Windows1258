...
rem ======================================================================
rem 
rem  sperl514 - execute perlscript on Strawbery Perl 5.8 without %PATH% settings
...
sperl514 - execute perlscript on Strawbery Perl 5.8 without %PATH% settings (poor App::perlbrew)
