...
rem ======================================================================
rem 
rem  sperl516 - execute perlscript on Strawbery Perl 5.16 without %PATH% settings
...
sperl516 - execute perlscript on Strawbery Perl 5.16 without %PATH% settings (poor App::perlbrew)
