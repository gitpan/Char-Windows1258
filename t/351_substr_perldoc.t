...
my $color  = Char::Windows1258::substr $s, 4, 5;   # black
my $middle = Char::Windows1258::substr $s, 4, -11; # black cat climbed the
my $end    = Char::Windows1258::substr $s, 14;     # climebed the green tree
my $tail   = Char::Windows1258::substr $s, -4;     # tree
my $z      = Char::Windows1258::substr $s, -4, 2;  # tr
