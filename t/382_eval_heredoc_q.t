...
eval Char::Windows1258::escape " if ('้ม' =~ /[แ]/i) { return 1 } else { return 0 } "
END
...
if (eval Char::Windows1258::escape <<'END') {
eval Char::Windows1258::escape qq{ if ('้ม' =~ /[แ]/i) { return 1 } else { return 0 } }
END
...
# eval <<'END' has eval '...'
if (eval Char::Windows1258::escape <<'END') {
eval Char::Windows1258::escape ' if (qq{้ม} =~ /[แ]/i) { return 1 } else { return 0 } '
END
...
# eval <<'END' has eval q{...}
if (eval Char::Windows1258::escape <<'END') {
eval Char::Windows1258::escape q{ if ('้ม' =~ /[แ]/i) { return 1 } else { return 0 } }
END
