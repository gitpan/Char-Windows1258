...
# Char::Windows1258::eval <<"END" has Char::Windows1258::eval "..."
if (Char::Windows1258::eval <<"END") {
...
# Char::Windows1258::eval <<"END" has Char::Windows1258::eval qq{...}
if (Char::Windows1258::eval <<"END") {
...
# Char::Windows1258::eval <<"END" has Char::Windows1258::eval q{...}
if (Char::Windows1258::eval <<"END") {
...
# Char::Windows1258::eval <<"END" has Char::Windows1258::eval $var
my $var = q{q{ if ('้ม' =~ /[แ]/i) { return 1 } else { return 0 } }};
if (Char::Windows1258::eval <<"END") {
Char::Windows1258::eval $var
END
...
# Char::Windows1258::eval <<"END" has Char::Windows1258::eval (omit)
...
# Char::Windows1258::eval <<"END" has qq{...}
if (Char::Windows1258::eval <<"END") {
...
# Char::Windows1258::eval <<"END" has q{...}
if (Char::Windows1258::eval <<"END") {
...
# Char::Windows1258::eval <<"END" has $var
my $var1 = 1;
my $var0 = 0;
if (Char::Windows1258::eval <<"END") {
